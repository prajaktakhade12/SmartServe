...
urlpatterns = [
    ...
    path('issue/<int:issue_id>/reassign/', views.reassign_issue),
    path('issue/<int:issue_id>/escalate/', views.escalate_issue),
    ...
    path('officer/list/', views.officer_list),
    path('officer/stats/', views.officer_stats),
    path('officer/profile-stats/', views.officer_profile_stats),  # ← NEW
]